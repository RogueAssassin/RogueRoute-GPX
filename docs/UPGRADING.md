...
v12.6.1 changes the default for new installations from the legacy Docker Hub
...
If the checkout or map directory was previously populated with `sudo`, v12.6.1
